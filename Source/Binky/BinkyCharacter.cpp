...
void ABinkyCharacter::NotifyControllerChanged()
{
...
void ABinkyCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ABinkyCharacter::Move);
...
void ABinkyCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
